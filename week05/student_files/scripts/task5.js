...
// Step 5: Using an if statement, set the message variable to 'Woohoo!  It is the weekend!'
if (dayOfWeek === 0 || dayOfWeek === 6 || theDay === '11/25') {
    message1 = 'Woohoo!  It is rest day, halala!!!';
} 
// Step 6: Using an else statement, if the day of the week is a weekday (i.e. Monday - Friday), set the message variable to the string 'Hang in there!'
else message1 = `Hang in there! Today is actually ${dayOfWeekString}`;
...
const sortBy = () => {
    ...
    switch(filter){
        ...
        case 'des':
            ...
            break;
        case '2000':
            output(templeList.filter(temple => temple.dedicated.substr(temple.dedicated.length - 4, 4) <
            filter));
            break;
        default:
            output(
                templeList.sort((temple1, temple2) =>
                   temple1.templeName.toLowerCase() > temple2.temple.Name.toLowerCase()
                   ?1
